                    ...
                    if ($loop->have_posts()) {
                        while ($loop->have_posts()): $loop->the_post();
                            ...
                            if (strtotime($date) >= strtotime(current_time("m/d/Y")) || $noexpiry == 1) {
                                ...
                                <a data-bs-toggle="modal" data-bs-target="#service_subpage_request_coupon_form" onclick="couponBannerButtonClick(this);" class="btn btn-secondary mw-226 mt-2">Request Service <i class="icon-chevron-right text_18 line_height_18 ms-2"></i></a>
                                <?php
                            }
                        endwhile;
                        wp_reset_postdata();
